use crate::KeyStore;
use crate::algorithms::{Kuznechik, AlgEcb, AlgCtr, AlgOfb, AlgCbc, AlgCfb, AlgMac};
...
fn expand_key() {
    ...
    let kuz = KeyStore::new().master_key(master_key);
...
fn encrypt_decrypt_alg_ecb() {
    ...
    assert_eq!(
        enc_data[..64],
        vec![0x7f, 0x67, 0x9d, 0x90, 0xbe, 0xbc, 0x24, 0x30, 0x5a, 0x46, 0x8d, 0x42, 0xb9, 0xd4, 0xed, 0xcd,
...
fn encrypt_decrypt_alg_ctr() {
    ...
    assert_eq!(
        enc_data,
        vec![0xf1, 0x95, 0xd8, 0xbe, 0xc1, 0x0e, 0xd1, 0xdb, 0xd5, 0x7b, 0x5f, 0xa2, 0x40, 0xbd, 0xa1, 0xb8,
...
fn encrypt_decrypt_alg_ofb() {
    ...
    assert_eq!(
        enc_data,
        vec![0x81, 0x80, 0x0a, 0x59, 0xb1, 0x84, 0x2b, 0x24, 0xff, 0x1f, 0x79, 0x5e, 0x89, 0x7a, 0xbd, 0x95,
...
fn encrypt_decrypt_alg_cbc() {
    ...
    assert_eq!(
        enc_data[..64],
        vec![0x68, 0x99, 0x72, 0xd4, 0xa0, 0x85, 0xfa, 0x4d, 0x90, 0xe5, 0x2e, 0x3d, 0x6d, 0x7d, 0xcc, 0x27,
