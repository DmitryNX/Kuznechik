...
* ```
* use self::kuznechik::{KeyStore, Algorithm, AlgOfb};
*
...
impl KeyStore {
    ...
    pub fn password(mut self, password: &str) -> Self /*Result<Self, &'static str>*/ {
        // if password.len() < 4 {
    ...
    pub fn master_key(mut self, master_key: Block256) -> Self {
