...
use crate::types::{Block128, Block256};
use crate::transforms::{tfm_c, tfm_f};
...
* ```
* use crate::kuznechik::{KeyStore, Kuznechik, AlgOfb};
*
...
* ];
*
* let key_store = KeyStore::with_master_key(master_key);
* let mut cipher = AlgOfb::new(&key_store).gamma(gamma.clone());
*
...
impl KeyStore {
    ...
    pub fn with_master_key(master_key: Block256) -> Self {
        let mut instance = Self::new();
        instance.set_master_key(master_key);
        instance
    }
    ...
    pub fn set_master_key(&mut self, master_key: Block256) {
